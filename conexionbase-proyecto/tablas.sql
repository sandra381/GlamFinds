use glamfinds; -- Selecciona la base de datos del proyecto

-- Tabla de usuarios (login, datos personales e imagen de perfil)
...
SELECT * FROM USUARIOS; -- Consulta de prueba: lista todos los usuarios
drop table usuarios; -- Elimina la tabla (usado durante desarrollo/pruebas)

-- Tabla de categorías de contenido (Ropa, Maquillaje, Accesorios, etc.)
create table categorias(
id_categoria int auto_increment,
name_categoria varchar(200),
primary key(id_categoria)
);
select * from categorias; -- Consulta de prueba: lista todas las categorías
-- Inserta las categorías iniciales disponibles en la app
...
-- Tabla de publicaciones generales (posts creados por usuarios, ligados a una categoría)
...
-- Datos de ejemplo: posts iniciales de distintas categorías
...
-- Trae los posts de la categoría 1 junto con el nombre del usuario y la categoría (join manual)
...
-- Tabla de publicaciones publicitarias (con link externo, ligadas a una categoría)
