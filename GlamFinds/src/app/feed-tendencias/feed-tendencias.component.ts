...
@Component({
  ...
  templateUrl: './feed-tendencias.component.html',
  styleUrls: ['./feed-tendencias.component.scss']
})
export class FeedTendenciasComponent implements OnInit {
  ...
  cargarTendencias() {
    this.loading = true;
    this.backend1.obtenerFeedTendencias().subscribe(
      async x => {
