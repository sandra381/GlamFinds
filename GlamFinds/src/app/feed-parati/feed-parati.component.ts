...
@Component({
  selector: 'app-feed-parati',
  templateUrl: './feed-parati.component.html',
  styleUrls: ['./feed-parati.component.scss']
})
export class FeedParatiComponent implements OnInit {
  ...
  cargarParaTi() {
    ...
    this.loading = true;
    this.backend1.obtenerFeedParaTi(userId).subscribe(
      async x => {
