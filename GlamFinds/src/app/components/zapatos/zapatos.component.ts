...
// Nombre de una prenda/calzado usado para filtrar los posts por tipo de artículo.
interface Prenda{
  name: string;
}

// Componente del feed de la categoría "Zapatos" (ruta "/zapatos").
// Muestra el listado de posts de zapatos estilo Pinterest (masonry), con
...
export class ZapatosComponent implements OnInit {
  // Todos los posts de zapatos obtenidos del backend, sin filtrar.
  ...
  // Diccionario de tipos de prenda/calzado disponibles para filtrar (clave = nombre en inglés usado por la IA).
  ...
  // Pide al backend todos los posts de zapatos y, por cada uno: inicializa
